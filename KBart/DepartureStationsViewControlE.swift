//
//  DepartureStationsViewControlE.swift
//  KBart
//
//  Created by Kenneth Ceglia on 4/1/15.
//  Copyright (c) 2015 KenCeglia. All rights reserved.
//

import UIKit

class DepartureStationsViewControlE: UIViewController , UITableViewDelegate , UITableViewDataSource {
    
    @IBOutlet weak var departureStationsTable: UITableView!
    var destinationStations : DestinationStations?
    //var selectedStation : Station!
    var selStationAbbr = String("RICH")
    ...
    func FireGetDepartureStations()
    {
        ...
        dispatch_async(GetDataQueue_serial(),
            {
                var destStations : DestinationStations = GetDestinationStations(forStationAbbr :self.selStationAbbr)
